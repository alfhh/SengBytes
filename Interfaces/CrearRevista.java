...
import controles.ControlCrearRevista; // Conection to the control

public class CrearRevista extends HttpServlet
{
    ControlCrearRevista controlU;
  ...
  public void loadForm() {
        ...
        out.println("<form data-abide method=\"GET\" action=\"CrearRevista\">");
        out.println("<input type=\"hidden\" name=\"check\" value=\"validate\"/>");
        out.println("<input type=\"submit\" name=\"submit\" value=\"Crear Revista\" />");
        out.println("</form>");
  ...
  public void validateData() {
    boolean flag = false;
   controlU = new ControlCrearRevista();
